...
module Authorization
  module AuthorizationInController
    ...
    module ClassMethods
      ...
      # present.
      #   class UserController < ApplicationControllerCore
      ...
      #   class BranchesController < ApplicationControllerCore
      ...
      #   class CompanyController < ApplicationControllerCore
      ...
      #   class BranchController < ApplicationControllerCore
