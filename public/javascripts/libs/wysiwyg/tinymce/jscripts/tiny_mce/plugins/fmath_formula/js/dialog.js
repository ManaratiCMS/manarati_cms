...
var MathML_FormulaDialog = {
	...
	insert : function() {
		...
		var imgName = document.getElementById('mathml_n').value;
                ...
                // Corection de bug : Insetion d'une chemin Absolu sans http://'
                imgName = "/media" +  imgName.split("media")[1]


		var newName = tinyMCEPopup.editor.plugins["fmath_formula"].addMathML(mathml);

		var imgTag = '<img id="'+newName+'" class="img_math" src="'+imgName+'" border="0"/>';
